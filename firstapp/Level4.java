...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.Level4);//установили текст
        ...
        dialogfon.setBackgroundResource(R.drawable.prewievbackground4);
        //Устанавливаем фон диалогового окна - конец

        //устанавливаем описание задания - начало
        TextView textdescription = (TextView)dialog.findViewById(R.id.textdesciption);
...
//кнопка закрытия диалогового окна начало
        ...
        dialogfonEnd.setBackgroundResource(R.drawable.prewievbackground4);
        //Устанавливаем фон диалогового окна - конец

        //Интересный факт - начало
        TextView textdesctiptionEnd = (TextView)dialogEnd.findViewById(R.id.textdesciptionEnd);
        textdesctiptionEnd.setText(R.string.leveltreeEnd);
...
btn_back.setBackgroundResource(R.drawable.button_stroke_black95_white);
...
**/
        ...
        text_left.setText(array.text4[numLeft]);//достаём из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==20){
                        ...
                        numLeft = random.nextInt(20);//генерируем случайное число
                        img_left.setImageResource(array.images4[numLeft]);//достаём из массива картинку
                        text_left.setText(array.text3[numLeft]);//достаём из массива текст
